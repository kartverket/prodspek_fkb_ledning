...
image::figurer/bardun_minstestorrelse.png[link=figurer/bardun_minstestorrelse.png, Alt="Illustrasjon av hvordan minstemål for bardun skal måles. Minimum utstrekning i grunnriss 15 meter måles fra senter bardun til senter fot mast"]
...
N&#229;r flere Kabelkanal ligger parallelt i bredde, skal hver enkelt Kabelkanal registreres. N&#229;r flere Kabelkanal ligger parallelt i h&#248;yde, skal den &#248;verste Kabelkanal registreres og p&#229;f&#248;res medium L. 

Kabelkanal skal registreres fullstendig over bruer og p&#229;f&#248;res medium L.

*I FKB er det kun kanaler som er synlige i terrenget som skal registreres. Oftest tilh&#248;rende Bane NOR.*
 
 
'''
.Registrering av kabelkanal. I bildet oppe til høyre er deler av Kabelkanal i luft, og skal derfor påføres medium L (foto: Bane NOR)
image::figurer\kabelkanal1.png[link=figurer\kabelkanal1.png, Alt="Registrering av kabelkanal. I bildet oppe til høyre er deler av Kabelkanal i luft, og skal derfor påføres medium L (foto: Bane NOR)"]
 
 
'''
.Illustrasjon av registrering for Kabelkanal med flere kanaler i bredde. Hver Kabelkanal skal registeres.
image::figurer\kabelkanal2_bredde.png[link=figurer\kabelkanal2_bredde.png, Alt="Illustrasjon av registrering for Kabelkanal med flere kanaler i bredde. Hver Kabelkanal skal registeres."]
...
image::figurer\kabelkanal3_hoyde.png[link=figurer\kabelkanal3_hoyde.png, Alt="Illustrasjon av registrering for Kabelkanal med flere kanaler i høyde med medium L. Øverste Kabelkanal skal registreres, med MEDIUM L."]
...
Kumlokk som inng&#229;r i Kum skal registereres, selv om Kum er under minstem&#229;l og ikke registreres. Kum og Kumlokk skal alltid p&#229;f&#248;res LEDNINGSNETTVERKSTYPE ekom hvis de henger sammen med Kabelkanal.

Baliser regnes ikke som Kumlokk. Baliser ligger som regel i Spormidt og er gule i fargen. Bilde p&#229; baliser under.
 
 
'''
.Illustrasjon av baliser som ikke skal registreres.
image::figurer\kumlokk1_baliser.png[link=figurer\kumlokk1_baliser.png, Alt="Illustrasjon av baliser som ikke skal registreres."]
...
*Definisjon:* anlegg for str&#248;mforsyning gjennom takmontert str&#248;mavtakerutstyr p&#229; elektriske kj&#248;ret&#248;y    For kontaktledningsmaster angis egenskapen _konstruksjon_ med verdien "enkelStolpe". Disse mastene skal p&#229;f&#248;res _ledningsnettverkstype_ "kontaktledning".
...
*Lavspent og ekom traseer skal ikke fotogrammetrisk registreres med mindre dette avtales s&#230;rskilt (er opsjonelt).*
...
Fotavtrykket for Vindturbin registreres som Vindturbinomriss. Vindturbin skal registreres som _hovedbruk_ hogspent.
...
[discrete]
==== Tilleggsinformasjon for fotogrammetrisk registrering
Omriss av Vindturbin. Vindturbinomriss skal registreres som _hovedbruk_ hogspent.
...
Ogs&#229; halv&#229;k (konstruksjon festet i kun en mast) skal registreres. Mastene som ikke er en del av objekttypen &#229;k, skal registreres som objekttype Mast.
 
 
'''
.Eksempel på registrering av Åk. Den enkelte mast registreres i tillegg.
image::figurer\åk1.png[link=figurer\åk1.png, Alt="Eksempel på registrering av Åk. Den enkelte mast registreres i tillegg."]
 
 
'''
.Illustrasjon av registrering for halvåk. Grønn linje representerer Åk, rød punkt Mast.
image::figurer\åk2_halvåk.png[link=figurer\åk2_halvåk.png, Alt="Illustrasjon av registrering for halvåk. Grønn linje representerer Åk, rød punkt Mast."]
